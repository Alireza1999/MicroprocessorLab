...
; 0000 0020     TCNT0 = 22;
	LDI  R30,LOW(22)
	OUT  0x32,R30
; 0000 0021      ++TimerOverflowCounter;
	LDI  R26,LOW(_TimerOverflowCounter_G000)
	LDI  R27,HIGH(_TimerOverflowCounter_G000)
	LD   R30,X+
	LD   R31,X+
	ADIW R30,1
	ST   -X,R31
	ST   -X,R30
; 0000 0022     if(TimerOverflowCounter ==25){
	LDS  R26,_TimerOverflowCounter_G000
	LDS  R27,_TimerOverflowCounter_G000+1
	SBIW R26,25
	BRNE _0x3
; 0000 0023 
; 0000 0024         PORTA.0=PORTA.0 ^ 1;
	LDI  R26,0
	SBIC 0x1B,0
	LDI  R26,1
	LDI  R30,LOW(1)
...
_0x4:
	SBI  0x1B,0
_0x5:
; 0000 0025         TimerOverflowCounter=0 ;
	LDI  R30,LOW(0)
	STS  _TimerOverflowCounter_G000,R30
	STS  _TimerOverflowCounter_G000+1,R30
; 0000 0026     }
; 0000 0027 
; 0000 0028 }
_0x3:
