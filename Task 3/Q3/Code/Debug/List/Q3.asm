...
; 0000 002C         TCCR1B = 0;
	...
	OUT  0x2E,R30
; 0000 002D 
; 0000 002E 		if(riseStartEdge < riseEndEdge)
	__CPWRR 4,5,8,9
	BRSH _0xF
; 0000 002F 		{
; 0000 0030 			period = riseEndEdge - riseStartEdge;
	MOVW R30,R8
	SUB  R30,R4
	SBC  R31,R5
	MOVW R10,R30
