...
; 0000 006C // RS - PORTA Bit 0
; 0000 006D // RD - PORTA Bit 1
; 0000 006E // EN - PORTA Bit 2
; 0000 006F // D4 - PORTA Bit 4
; 0000 0070 // D5 - PORTA Bit 5
; 0000 0071 // D6 - PORTA Bit 6
; 0000 0072 // D7 - PORTA Bit 7
...
; 0000 0079       lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 007A       lcd_putsf("Hello Word");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 007B 
; 0000 007C       }
